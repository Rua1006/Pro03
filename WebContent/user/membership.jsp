...
<style>
.page_wrap {position: relative; padding-bottom: 30px; width: 50%; margin: 0 auto;}
...
<br><br><br><br><br><br>
<h2 class="page_title">개인정보 이용 약관</h2>
<div class="agree_fr" id="content">
<article>개인정보 수집 안내
○ 개인정보의 수집의 목적
   - 본인 확인절차
...
○ 개인정보 수집 항목
   - 성명, 생년월일, 사진, 이메일 주소, 전화번호 (휴대폰, 전화번호), 주소, 학력 및 성적확인서
...
○ 동의하지 않을 경우의 처리
   - 이용자는 개인정보 수집 및 제공 동의에 거부할 수 있으며, 이 경우 채용 절차(사실 확인 등)가 제한됨으로 채용상 불이익을 초래할 수  있습니다.
	...
	<div class="btn-group">
		...
		<button type="button" id="in_btn1" name="in_btn1" class="btn button is-link"> 다음 단계</button>
	</div>
	</section>
	</div>
<script>
